...
public class CalcServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String resultado = "";
        int a = Integer.parseInt(request.getParameter("valor1"));
        int b = Integer.parseInt(request.getParameter("valor2"));
        String opcion = request.getParameter("operacion");
        if(opcion.equals("Sumar")){
        resultado = calcBean.PlusOperation(a, b) + "";
        }else if(opcion.equals("Restar")){
        resultado = calcBean.Rest(a, b) + "";
        }else if(opcion.equals("Multiplicar")){
        resultado = calcBean.Mult(a, b) + "";
        }else if(opcion.equals("Dividir")){
        resultado = calcBean.Div(a, b) + "";
        }else if(opcion.equals("Modulo")){
        resultado = calcBean.Module(a, b) + "";
        }
